...
const de: Record<string, Guidance> = {
  ...
  'reported-mails': {
    intro:
      'Von Beschäftigten gemeldete verdächtige E-Mails. Aktuell werden sie als .eml hochgeladen; sobald der Mail-Report-Button verfügbar ist, landen Meldungen automatisch hier.',
    steps: [
  ...
  'settings-privacy': {
    ...
    steps: [
      ...
      'Aufbewahrungsfrist eintragen — ohne Eintrag wird nichts automatisch gelöscht. Mit Frist werden abgeschlossene Kampagnen stündlich geprüft und anonymisiert; die Kennzahlen bleiben, die Personen verschwinden.',
    ],
...
const en: Record<string, Guidance> = {
  ...
  'reported-mails': {
    intro:
      'Suspicious emails reported by employees. For now they are uploaded as .eml files; once the mail report button is available, reports arrive here automatically.',
    steps: [
